...
export function FileList({ file_name, file,file_Size, fromid, recievedData, bse64toFileUrl, downloadRef }) {
  ...
  return (
    ...
    <div className="file_wrapper">
      ...
      <div className="file_right_side">
        ...
        <a ref={downloadRef} download={file_name} href="#"><FiDownload className="download" onClick={() => { bse64toFileUrl(file) }}/></a>
